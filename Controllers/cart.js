...
const addToCart = async (req, res, next) => {
    ...
    try {
        if (!cart.items.id(product._id)) {
            ...
            let updatedCart = extend(cart, { ...cart, items: concat(cart.items, newProduct) })
...
module.exports = { getCartById, getCartItems, addToCart, modifyCartItemsQty, deleteItemFromCart }